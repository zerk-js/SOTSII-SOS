...
// Type: Kerberos.Sots.Data.ScenarioFramework.RebellionEndsAction
...
{
	public class RebellionEndsAction : TriggerAction
	{
		public string OrbitName = "";
		internal const string XmlRebellionEndsActionName = "RebellionEnds";
