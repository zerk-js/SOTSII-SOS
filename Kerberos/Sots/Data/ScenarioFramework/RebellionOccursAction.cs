...
// Type: Kerberos.Sots.Data.ScenarioFramework.RebellionOccursAction
...
{
	public class RebellionOccursAction : TriggerAction
	{
		public string OrbitName = "";
		internal const string XmlRebellionOccursActionName = "RebellionOccurs";
