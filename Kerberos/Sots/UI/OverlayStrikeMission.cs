...
// Type: Kerberos.Sots.UI.OverlayStrikeMission
...
{
	internal class OverlayStrikeMission : OverlayMission
	{
		...
		{
			return string.Format(App.Localize("@UI_STRIKE_OVERLAY_MISSION_TITLE"), (object)this.App.GameDatabase.GetStarSystemInfo(this.TargetSystem).Name.ToUpperInvariant());
		}
