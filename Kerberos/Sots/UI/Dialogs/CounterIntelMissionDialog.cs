...
// Type: Kerberos.Sots.UI.Dialogs.CounterIntelMissionDialog
...
namespace Kerberos.Sots.UI.Dialogs
{
	internal class CounterIntelMissionDialog : Dialog
	{
		...
		public CounterIntelMissionDialog(GameSession game, int targetPlayer)
		  : base(game.App, "dialogCounterIntelSummary")
		{
		...
		public override void Initialize()
		{
			...
			int counterIntelPoints = playerInfo1.CounterIntelPoints;
			int pointsForMission = this._game.AssetDatabase.RequiredCounterIntelPointsForMission;
			bool flag = counterIntelPoints >= pointsForMission;
			...
			stringBuilder.Append(string.Format(App.Localize("@UI_DIPLOMACY_COUNTER_INTEL_INFO_DESC_POINTS_REQUIRED") + "\n", (object)pointsForMission, (object)counterIntelPoints));
			stringBuilder.Append(string.Format(App.Localize("@UI_DIPLOMACY_COUNTER_INTEL_INFO_DESC_CHANCE"), (object)GameSession.GetIntelSuccessRollChance(this._game.AssetDatabase, this._game.GameDatabase, playerInfo1.ID, playerInfo2.ID), (object)5));
